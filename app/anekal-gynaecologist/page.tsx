...
export const metadata: Metadata = {
  title: 'Best Gynaecologist in Anekal | Dr. Sanjana L — Raghava Hospital',
  description:
    'Looking for the best gynaecologist in Anekal? Dr. Sanjana L (MBBS, MS OBG, Gold Medalist) at Raghava Multispeciality Hospital, Attibele offers expert pregnancy care, normal & painless delivery, PCOS treatment, fertility support and laparoscopic surgery — a short drive from Anekal.',
  keywords: [
    'best gynaecologist in Anekal',
    'gynaecologist Anekal',
    'lady gynaecologist Anekal',
    'obstetrician Anekal',
    'pregnancy doctor Anekal',
    'normal delivery doctor Anekal',
    'maternity hospital near Anekal',
    'delivery hospital near Anekal',
    'PCOS treatment Anekal',
    'fertility specialist near Anekal',
    'gynaecologist near Anekal Town',
    'gynaecologist Anekal taluk',
  ],
  alternates: {
    canonical: `${SITE_URL}/anekal-gynaecologist`,
  },
  openGraph: {
    title: 'Best Gynaecologist in Anekal | Dr. Sanjana L — Raghava Hospital',
    description:
      'Dr. Sanjana L at Raghava Multispeciality Hospital, Attibele — 10+ years experienced gynaecologist a short drive from Anekal. Expert pregnancy care, normal delivery, PCOS treatment & more.',
    url: `${SITE_URL}/anekal-gynaecologist`,
    type: 'website',
    locale: 'en_IN',
...
const services = [
  {
    ...
    desc: 'Complete prenatal care from first trimester to delivery — check-ups, scans, nutrition guidance and birth planning close to Anekal.',
    href: '/services/pregnancy-care',
  },
  {
    icon: HeartPulse,
    title: 'Normal & Painless Delivery',
    desc: 'Safe vaginal deliveries with a normal-delivery-first approach and epidural painless delivery available at Raghava Hospital, a short drive from Anekal.',
...
const faqs: { q: string; a: string }[] = [
  {
    q: 'Who is the best gynaecologist in Anekal?',
    a: 'Dr. Sanjana L consults at Raghava Multispeciality Hospital on the Sarjapura–Attibele Road, a short drive from Anekal town. She is a trusted lady obstetrician and gynaecologist for the Anekal taluk.\n\nShe is MBBS, MS (OBG) Gold Medalist (RGUHS), and FMAS-trained, with 10 plus years of experience. She supports pregnancy, normal and painless birth, PCOS care, fertility, and keyhole surgery.\n\nTimings: Mon–Sat, 9 AM–9 PM. She also consults at Health Nest, HSR Layout.',
  },
  {
    q: 'How far is the hospital from Anekal?',
    a: 'Raghava Hospital is at Attibele, on the Sarjapura–Attibele Road, a short drive from Anekal town via the Anekal–Attibele Road.\n\nIt is a much closer, well-equipped option than travelling to Electronic City or the city centre for maternity and gynaecology care.',
  },
  {
    q: 'Where can I have a normal or painless delivery near Anekal?',
  ...
  {
    q: 'Can I consult Dr. Sanjana online if I live in Anekal?',
...
const localBusinessSchema = {
  ...
  name: 'Dr. Sanjana L — Gynaecologist in Anekal (Raghava Hospital, Attibele)',
  description:
    'Best gynaecologist in Anekal offering pregnancy care, normal and painless delivery, PCOS treatment, fertility support and laparoscopic surgery at Raghava Multispeciality Hospital, Attibele.',
  url: `${SITE_URL}/anekal-gynaecologist`,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Gynaecologist in Anekal',
      item: `${SITE_URL}/anekal-gynaecologist`,
    },
  ],
};
...
export default function AnekalGynaecologistPage() {
  return (
    <>
      {/* Structured Data */}
      <script
      ...
      <main id="main-content">
          ...
          <div className="container-hn">
            ...
            <div className="mt-6 grid lg:grid-cols-12 gap-10 items-start">
              ...
              <div className="lg:col-span-7">
                ...
                >
                  Anekal &middot; Attibele &middot; Chandapura &middot; Jigani
                </span>
                ...
                >
                  ...
                  Anekal. She has 10 plus years of experience, is an{' '}
                ...
                <p
                  ...
                  style={{ color: '#6B6B6B', fontFamily: 'var(--font-body), system-ui, sans-serif' }}
                >
                  She cares for women across the Anekal taluk — Anekal town, Attibele, Chandapura and
                  Jigani. Common reasons for visits include <strong>pregnancy check-ups</strong>,{' '}
                ...
                >
                  ...
                  <div className="mt-5 rounded-xl overflow-hidden" style={{ height: '200px' }}>
                    <iframe
                      ...
                      title="Raghava Multispeciality Hospital — near Anekal"
                    />
                  </div>
        ...
        <section className="section-padding" style={{ background: '#FFFFFF' }}>
          <div className="container-hn max-w-4xl">
            <h2
              ...
              style={{ fontFamily: 'var(--font-display), Georgia, serif', color: '#2D2D2D' }}
            >
              Why Women in Anekal Trust Dr. Sanjana L
            </h2>
            <div className="accent-line" />
            ...
            >
              <p>
                Families in the Anekal taluk have often had to travel far for a well-equipped maternity
                and gynaecology unit. Dr. Sanjana L consults at{' '}
                <strong>Raghava Multispeciality Hospital</strong>, Attibele — a short, familiar drive
                from Anekal rather than a long trip into the city.
              </p>
              <p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-8">
              {[
                ...
                'A short drive from Anekal, Chandapura & Jigani',
              ].map((item, i) => (
                <div
                  key={i}
          ...
          <div className="container-hn">
            <div className="text-center mb-12">
              <h2
                ...
                style={{ fontFamily: 'var(--font-display), Georgia, serif', color: '#2D2D2D' }}
              >
                Gynaecology Services for Anekal Families
              </h2>
            ...
            <div className="mt-10 max-w-3xl mx-auto text-center">
              <p
                ...
                style={{ color: '#6B6B6B', fontFamily: 'var(--font-body), system-ui, sans-serif' }}
              >
                <strong style={{ color: '#2D2D2D' }}>Also available for Anekal patients:</strong>{' '}
        ...
        <AreaMoneyPageLinks
          ...
          heading={'Treatment & Delivery Guides near Anekal'}
          intro="Dr. Sanjana consults at Raghava Multispeciality Hospital, Attibele — the nearest unit to Anekal. These guides cover what each treatment involves and how to book."
          background="#FFF8F0"
        />
        ...
        <section className="section-padding" style={{ background: '#FFFFFF' }}>
          <div className="container-hn max-w-4xl">
            <h2
              ...
              style={{ fontFamily: 'var(--font-display), Georgia, serif', color: '#2D2D2D' }}
            >
              Serving Women across Anekal and Nearby Areas
            </h2>
            <div className="accent-line" />
            ...
            <div className="text-base mb-6 leading-relaxed max-w-[68ch] space-y-3" style={{ color: '#6B6B6B', fontFamily: 'var(--font-body), system-ui, sans-serif' }}>
              <p className="m-0">
                ...
                Anekal town and the surrounding taluk.
              </p>
              <p className="m-0">
                If you want a <strong>maternity hospital near Anekal</strong>, a{' '}
                <strong>lady gynaecologist near Jigani</strong>, or a{' '}
                <strong>delivery hospital near Chandapura</strong>, Dr. Sanjana L is often just a short
                drive away.
              </p>
            </div>
        ...
        <section className="section-padding" style={{ background: '#FFF8F0' }}>
          <div className="container-hn max-w-3xl">
            <h2
              ...
              style={{ fontFamily: 'var(--font-display), Georgia, serif', color: '#2D2D2D' }}
            >
              Frequently Asked Questions — Gynaecologist in Anekal
            </h2>
            <div className="accent-line" />
        ...
        >
          <div className="container-hn text-center">
            ...
            >
              Looking for a Trusted Gynaecologist in Anekal?
            </h2>
