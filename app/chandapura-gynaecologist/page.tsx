...
export const metadata: Metadata = {
  title: 'Best Gynaecologist in Chandapura | Dr. Sanjana L — Raghava Hospital',
  description:
    'Looking for the best gynaecologist in Chandapura? Dr. Sanjana L (MBBS, MS OBG, Gold Medalist) at Raghava Multispeciality Hospital, Attibele offers expert pregnancy care, normal & painless delivery, PCOS treatment, fertility support and laparoscopic surgery — about 10 minutes from Chandapura Circle.',
  keywords: [
    'best gynaecologist in Chandapura',
    'gynaecologist Chandapura',
    'lady gynaecologist Chandapura',
    'obstetrician Chandapura',
    ...
    'fertility specialist Chandapura',
    'gynaecologist near Chandapura Circle',
    'gynaecologist near Chandapura Anekal Road',
  ],
  alternates: {
    canonical: `${SITE_URL}/chandapura-gynaecologist`,
  },
  openGraph: {
    title: 'Best Gynaecologist in Chandapura | Dr. Sanjana L — Raghava Hospital',
    description:
      'Dr. Sanjana L at Raghava Multispeciality Hospital, Attibele — 10+ years experienced gynaecologist about 10 minutes from Chandapura. Expert pregnancy care, normal delivery, PCOS treatment & more.',
    url: `${SITE_URL}/chandapura-gynaecologist`,
    type: 'website',
    locale: 'en_IN',
...
const services = [
  {
    ...
    desc: 'Complete prenatal care from your first positive test to safe delivery — check-ups, scans, nutrition guidance and birth planning close to Chandapura.',
    href: '/services/pregnancy-care',
  },
  {
    icon: HeartPulse,
    title: 'Normal & Painless Delivery',
    desc: 'Safe vaginal deliveries with a normal-delivery-first approach and epidural painless delivery available at Raghava Hospital, minutes from Chandapura.',
...
const faqs: { q: string; a: string }[] = [
  {
    q: 'Who is the best gynaecologist in Chandapura?',
    a: 'Dr. Sanjana L consults at Raghava Multispeciality Hospital on the Sarjapura–Attibele Road, about 10 minutes from Chandapura Circle. She is a trusted lady obstetrician and gynaecologist for the area.\n\nShe is MBBS, MS (OBG) Gold Medalist (RGUHS), and FMAS-trained, with 10 plus years of experience. She supports pregnancy, normal and painless birth, PCOS care, fertility, and keyhole surgery.\n\nTimings: Mon–Sat, 9 AM–9 PM. She also consults at Health Nest, HSR Layout.',
  },
  {
    q: 'How do I reach the hospital from Chandapura?',
    a: 'Address: 39, Sarjapura–Attibele Road, opposite Syndicate Bank, Attibele, Bengaluru 562107.\n\nFrom Chandapura Circle it is roughly 10 minutes via Hosur Road and the Attibele–Sarjapura Road. Parking is available, and buses and cabs serve the route well.',
  },
  {
    q: 'Where can I have a normal or painless delivery near Chandapura?',
  ...
  {
    q: 'Is there a lady (female) gynaecologist near Chandapura?',
    a: 'Yes. Dr. Sanjana L is a woman gynaecologist at Raghava Hospital. Visits are private and respectful, and she speaks English, Hindi, Kannada, and Telugu.\n\nMany patients come from Chandapura, Anekal, Bommasandra, Jigani and Hosur Road.',
  },
  {
    q: 'What gynaecology services are available for Chandapura patients?',
    a: 'Pregnancy visits, scans and birth planning; normal, painless and caesarean birth; and treatment for PCOS, fibroids, ovarian cysts, endometriosis, period problems and fertility concerns.\n\nShe also performs laparoscopy and hysteroscopy, and offers cervical screening and contraception advice.',
  },
  {
  ...
  {
    q: 'Can I consult Dr. Sanjana online if I live in Chandapura?',
...
const localBusinessSchema = {
  ...
  name: 'Dr. Sanjana L — Gynaecologist in Chandapura (Raghava Hospital, Attibele)',
  description:
    'Best gynaecologist in Chandapura offering pregnancy care, normal and painless delivery, PCOS treatment, fertility support and laparoscopic surgery at Raghava Multispeciality Hospital, Attibele.',
  url: `${SITE_URL}/chandapura-gynaecologist`,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Gynaecologist in Chandapura',
      item: `${SITE_URL}/chandapura-gynaecologist`,
    },
  ],
};
...
export default function ChandapuraGynaecologistPage() {
  return (
    <>
      {/* Structured Data */}
      <script
      ...
      <main id="main-content">
        ...
        >
          <div className="container-hn">
            <BreadcrumbNav
              crumbs={[
                { label: 'Home', href: '/' },
                { label: 'Gynaecologist in Chandapura' },
              ]}
            />
            ...
            <div className="mt-6 grid lg:grid-cols-12 gap-10 items-start">
              ...
              <div className="lg:col-span-7">
                ...
                >
                  Chandapura &middot; Anekal &middot; Bommasandra &middot; Jigani
                </span>
                ...
                >
                  ...
                  <strong>Raghava Multispeciality Hospital, Attibele</strong> — about 10 minutes from
                  Chandapura Circle. She has 10 plus years of experience, is an{' '}
                ...
                <p
                  ...
                  style={{ color: '#6B6B6B', fontFamily: 'var(--font-body), system-ui, sans-serif' }}
                >
                  She cares for women across the Chandapura residential belt and nearby Anekal,
                  Bommasandra and Jigani. Common reasons for visits include{' '}
                ...
                >
                  ...
                  <div className="mt-5 rounded-xl overflow-hidden" style={{ height: '200px' }}>
                    <iframe
                      ...
                      title="Raghava Multispeciality Hospital — near Chandapura"
                    />
                  </div>
        ...
        <section className="section-padding" style={{ background: '#FFFFFF' }}>
          <div className="container-hn max-w-4xl">
            <h2
              ...
              style={{ fontFamily: 'var(--font-display), Georgia, serif', color: '#2D2D2D' }}
            >
              Why Women in Chandapura Trust Dr. Sanjana L
            </h2>
            <div className="accent-line" />
            ...
            >
              <p>
                The Chandapura belt has grown fast, but good maternity and gynaecology care nearby has
                lagged behind. Dr. Sanjana L consults at <strong>Raghava Multispeciality Hospital</strong>{' '}
                on the Attibele–Sarjapura Road, about 10 minutes from Chandapura Circle — so families
                here no longer have to drive to Electronic City or the city centre.
              </p>
              <p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-8">
              {[
                ...
                'About 10 minutes from Chandapura Circle',
              ].map((item, i) => (
                <div
                  key={i}
          ...
          <div className="container-hn">
            <div className="text-center mb-12">
              <h2
                ...
                style={{ fontFamily: 'var(--font-display), Georgia, serif', color: '#2D2D2D' }}
              >
                Gynaecology Services for Chandapura Families
              </h2>
            ...
            <div className="mt-10 max-w-3xl mx-auto text-center">
              <p
                ...
                style={{ color: '#6B6B6B', fontFamily: 'var(--font-body), system-ui, sans-serif' }}
              >
                <strong style={{ color: '#2D2D2D' }}>Also available for Chandapura patients:</strong>{' '}
        ...
        <AreaMoneyPageLinks
          ...
          heading={'Treatment & Delivery Guides near Chandapura'}
          intro="Dr. Sanjana consults at Raghava Multispeciality Hospital, Attibele — a short drive from Chandapura. These guides cover what each treatment involves and how to book."
          background="#FFF8F0"
        />
        ...
        <section className="section-padding" style={{ background: '#FFFFFF' }}>
          <div className="container-hn max-w-4xl">
            <h2
              ...
              style={{ fontFamily: 'var(--font-display), Georgia, serif', color: '#2D2D2D' }}
            >
              Serving Women across Chandapura and Nearby Areas
            </h2>
            <div className="accent-line" />
            ...
            <div className="text-base mb-6 leading-relaxed max-w-[68ch] space-y-3" style={{ color: '#6B6B6B', fontFamily: 'var(--font-body), system-ui, sans-serif' }}>
              <p className="m-0">
                Raghava Multispeciality Hospital sits on the Attibele–Sarjapura Road, an easy drive
                from Chandapura Circle and the surrounding residential layouts.
              </p>
              <p className="m-0">
                If you want a <strong>maternity hospital near Chandapura</strong>, a{' '}
        ...
        <section className="section-padding" style={{ background: '#FFF8F0' }}>
          <div className="container-hn max-w-3xl">
            <h2
              ...
              style={{ fontFamily: 'var(--font-display), Georgia, serif', color: '#2D2D2D' }}
            >
              Frequently Asked Questions — Gynaecologist in Chandapura
            </h2>
            <div className="accent-line" />
        ...
        >
          <div className="container-hn text-center">
            ...
            >
              Looking for a Trusted Gynaecologist in Chandapura?
            </h2>
